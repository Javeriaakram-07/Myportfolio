...
const skills: Skill[] = [
  {
    name: "C",
    icon: <span className="text-4xl font-bold gradient-text">C</span>,
    color: "skill-c",
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-12 h-12">
        <path
          fill="currentColor"
          d="M15.852 8.981h-4.588V0h4.588c2.476 0 4.49 2.014 4.49 4.49s-2.014 4.491-4.49 4.491zM12.735 7.51h3.117c1.665 0 3.019-1.355 3.019-3.02s-1.354-3.02-3.019-3.02h-3.117v6.04zm0 1.471H8.148c-2.476 0-4.49-2.015-4.49-4.491S5.672 0 8.148 0h4.588v8.981zm-4.587-7.51c-1.665 0-3.019 1.355-3.019 3.02s1.354 3.02 3.019 3.02h3.117V1.471H8.148zm4.587 15.019H8.148c-2.476 0-4.49-2.014-4.49-4.49s2.014-4.49 4.49-4.49h4.588v8.98zM8.148 8.981c-1.665 0-3.019 1.355-3.019 3.02s1.354 3.02 3.019 3.02h3.117v-6.04H8.148zm7.704 0c-.988 0-1.96.375-2.704 1.019v6.918c.744.644 1.716 1.019 2.704 1.019 2.476 0 4.49-2.014 4.49-4.49s-2.014-4.466-4.49-4.466z"
        />
      </svg>
    ),
    color: "skill-web",
    description: "Visual design with Figma and modern design tools",
  },
  {
    name: "React.js",
    icon: (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            A diverse set of technical skills built through academic learning
