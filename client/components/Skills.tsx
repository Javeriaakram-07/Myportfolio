...
const skills: Skill[] = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-12 h-12">
        <path fill="currentColor" d="M16.392 9.074c-.199-.376-.48-.715-.819-.986a3.59 3.59 0 0 0-1.176-.581c-.425-.129-.872-.193-1.34-.193-.468 0-.914.064-1.34.193a3.59 3.59 0 0 0-1.176.581c-.34.271-.62.61-.819.986-.199.376-.299.788-.299 1.237 0 .449.1.861.299 1.237.199.376.48.715.819.986.342.271.733.467 1.176.581.426.129.872.193 1.34.193.468 0 .915-.064 1.34-.193a3.59 3.59 0 0 0 1.176-.581c.34-.271.62-.61.819-.986.199-.376.299-.788.299-1.237 0-.449-.1-.861-.299-1.237zm-1.097 1.93c-.136.267-.327.491-.573.674-.245.183-.538.323-.879.42-.341.097-.716.145-1.125.145-.409 0-.784-.048-1.125-.145-.341-.097-.634-.237-.879-.42-.246-.183-.437-.407-.573-.674-.136-.267-.204-.566-.204-.898s.068-.631.204-.898c.136-.267.327-.491.573-.674.245-.183.538-.323.879-.42.341-.097.716-.145 1.125-.145.409 0 .784.048 1.125.145.341.097.634.237.879.42.246.183.437.407.573.674.136.267.204.566.204.898s-.068.631-.204.898z"/>
      </svg>
    ),
    color: 'skill-c',
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-12 h-12">
        <path fill="currentColor" d="M22.394 6c0-1.438-.935-2.7-2.314-3.129L13.596.264a4.04 4.04 0 0 0-2.851 0L4.261 2.871C2.882 3.3 1.947 4.562 1.947 6v12c0 1.438.935 2.7 2.314 3.129l6.484 2.607a4.04 4.04 0 0 0 2.851 0l6.484-2.607C21.459 20.7 22.394 19.438 22.394 18V6zM12 16.6c-2.538 0-4.6-2.062-4.6-4.6S9.462 7.4 12 7.4s4.6 2.062 4.6 4.6-2.062 4.6-4.6 4.6zm5.5-4.1h-.9v.9h-.9v-.9h-.9v-.9h.9v-.9h.9v.9h.9v.9zm3 0h-.9v.9h-.9v-.9h-.9v-.9h.9v-.9h.9v.9h.9v.9z"/>
      </svg>
    ),
    color: 'skill-cpp',
